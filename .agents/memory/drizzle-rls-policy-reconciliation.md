...
**How to apply:** Keep the Radar database-security initializer responsible for normalizing policy expressions, grants, and FORCE ROW LEVEL SECURITY after schema changes; verify with the database-security integration test.